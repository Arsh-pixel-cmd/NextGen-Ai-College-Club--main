...
const fields: FormField[] = [
  ...
  {
    name: 'snippet',
    label: 'Short Snippet (Card Summary)',
    type: 'textarea',
  ...
  {
    name: 'content',
    label: 'Full Article Content (Complete Story)',
    type: 'textarea',
    placeholder: 'Write the complete detailed blog article here. You can write multiple paragraphs...\n\nExample:\nArtificial intelligence has shifted into a new creative domain...\n\nNextGen AI Club members are building with frontier models...',
    rows: 8,
  },
  {
    name: 'image_url',
